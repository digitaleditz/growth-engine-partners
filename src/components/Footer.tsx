      ...
      <div className="grid md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="space-y-3 text-sm text-muted-foreground">
            <a href="mailto:hello@digitaleditz.com" className="flex items-center gap-2 hover:text-primary transition-colors">
              <Mail size={14} /> hello@digitaleditz.com
            </a>
            <a href="tel:+919000000000" className="flex items-center gap-2 hover:text-primary transition-colors">
              <Phone size={14} /> +91 90000 00000
            </a>
            <a href="https://wa.me/919000000000" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-primary transition-colors">
